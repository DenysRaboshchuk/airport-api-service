# Generated by Django 6.0.6 on 2026-06-12 14:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='route',
            name='destination',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_routes', to='airport.airport'),
        ),
        migrations.AddField(
            model_name='route',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_routes', to='airport.airport'),
        ),
        migrations.AddField(
            model_name='flight',
            name='route',
